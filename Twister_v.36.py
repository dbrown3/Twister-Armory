...
'''
v.35 allows zeroes as valid values in performance metrics
...
try:
    ...
    na_values=['NULL','-99', 'N/A', '#N/A', 'blank', 0], encoding='cp1252')    
    
except:
    print 'WARNING: Encoding defaulted to cp1252'    
    data = pd.read_csv(filename, index_col=['Ratee Unique ID', 'Rater Unique ID'], \
    na_values=['NULL','-99', 'N/A', '#N/A', 'blank', 0], encoding='utf-8')
...
if userq_cso_try == 'Y':
    ...
    try:    
        ...
        print("You need python-docx. Enter the following in your command prompt: \n\n\
        pip install python-docx \n\nAfter the library installs, re-run the program.")        
#        pip install python-docx
#        from docx import Document
#        from docx.shared import Inches
#   
